...
<html>
    <head>
        ...
        <title> Job Portal - Add Education </title>
                                ...
                                <form method="POST" action="AddEducationDetails">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <h3> Add Education Details <span style="margin-left: 60px;"> </h3> <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input class="reglog_tf_design" name="school1" type="text" value="" placeholder="Ex. Boston University" /> <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input class="reglog_tf_design" name="degree1" type="text" value="" placeholder="Ex. Bachlor's" /> <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input class="reglog_tf_design" name="studyfield1" type="text" value="" placeholder="Ex. Computer Science" /> <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="reglog_tf_design" name="grade1" type="text" value="" placeholder="Ex. Percentage or YGPA" />  <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <textarea class="reglog_ta_design" name="description1" placeholder="Ex. Your Certification , Activities and Societies" type="text" value="" ></textarea> <br><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input type="submit" value="ADD EDUCATION" class="btn btn-primary search_btn" /> <br>
